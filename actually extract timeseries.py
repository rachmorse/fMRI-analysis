...
def process_subject(args):
    ...
    (subject_id, ses, threshold, bold_template, mask_template, masks_root_path, 
     output_dir, roi_indices, mask_type, error_log_path, selected_rois_csv, roi_column_name, subjects) = args  
...
def main(ses: str, 
    ...
    args = [(subject, ses, threshold, bold_template, mask_template, masks_root_path, output_dir, roi_indices, mask_type, error_log_path, selected_rois_csv, roi_column_name, subjects) for subject in todo]
