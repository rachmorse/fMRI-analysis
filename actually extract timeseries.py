...
def process_subject_extract(args):
    ...
    timeseries_output_path = output_dir / f"{subject_id}_timeseries_new.csv"
...
if __name__ == "__main__":
    ...
    # main(ses=ses, threshold=threshold, todo_path=todo_file, masks_root_path=masks_root_path, output_dir=output_directory, bold_template=bold_template, mask_template=mask_template, mask_type=mask_type, multi=True)
